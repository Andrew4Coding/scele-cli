...
| **Skill** | instructions telling an agent *when and how* to call `scele` | `scele skill` or `npx skills add Andrew4Coding/scele-cli` |
...
## Install the skill — `scele skill`

If you installed `scele` via npm (`npm install -g scele-cli`):
